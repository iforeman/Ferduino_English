...
const int iniC[]= {325, 2, 390, 42};           // inicio
const int menU[]= {325, 52, 390, 92};       // Botao menu
const int prOK[]= {325, 200, 390, 238};        //ok
const int salV[]= {325, 150, 390, 190};        //salvar dosagem
const int deS[]= {325, 102, 390, 142};
...
const byte leWB[]= {5, 203, 90, 235};        //LED values show whites or blues
const byte leST[]= {100, 203, 170, 235};       //LED values change
...
const int volT[]= {325, 200, 390, 238};         //voltar
...
const byte stsT[]= {90, 155, 220, 225};     //start/stop
const byte tenM[]= {10, 170, 80, 210};       //-10s
...
const byte domI[]= {120, 193, 200, 233};      //domingo
